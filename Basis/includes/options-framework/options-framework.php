...
function optionsframework_init() {
	...
	// Optionally Loads the options file from the theme - Josiah EDIT
	$location = apply_filters( 'options_framework_location', array( 'options.php' ) );
	$optionsfile = locate_template( array('includes/basis-options.php') );
...
function &_optionsframework_options() {
	...
	if ( !$options ) {
		// Load options from options.php file (if it exists) - Josiah EDIT
		$location = apply_filters( 'options_framework_location', array('options.php') );

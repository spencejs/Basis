 ...
 * we supplied in includes/basis-options.php.  This is a neat way to do it since
...
function optionsframework_init() {
	...
	if ( $optionsfile = locate_template( array('includes/basis-options.php') ) ) {
		require_once($optionsfile);
	}
	else if (file_exists( dirname( __FILE__ ) . '/includes/basis-options.php' ) ) {
		require_once dirname( __FILE__ ) . '/includes/basis-options.php';
	}
 ...
 * activation since most people won't be editing the includes/basis-options.php
 * on a regular basis.
 *
...
function optionsframework_setdefaults() {
	...
	// Gets the default options data from the array in includes/basis-options.php
...
function optionsframework_validate( $input ) {
	 ...
	 * button, the options defined in the theme's includes/basis-options.php
 ...
 * includes/basis-options.php. The 'id','std' and 'type' keys need
